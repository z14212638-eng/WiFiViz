...
![PHY 状态扇形图](img/phy-state-pie-chart.png)

PHY 状态扇形图统计 IDLE、TX、RX、CCA_BUSY、SWITCHING、SLEEP、OFF、UNKNOWN 等状态的时长占比。中心数值显示单 PHY 平均观测时长，tooltip 同时显示聚合总时长、单 PHY 平均时长和百分比。
