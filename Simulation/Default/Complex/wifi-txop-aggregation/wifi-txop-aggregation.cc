...
int main(int argc, char *argv[]) {
  ...
  cmd.AddValue("enable-wifiviz", "Enable WiFiViz timeline capture",
               enableWiFiViz);
  ...
  NetDeviceContainer allDevices = WiFiVizHelper::MergeDevices(allApDevices, allStaDevices);
  WiFiVizHelper::ConfigureVisualizerSampling(precise, rough);
  Ptr<SniffUtils> Sniff_Utils = WiFiVizHelper::MaybeEnableVisualizer(
      enableWiFiViz, allDevices, simulationTime.ToDouble(Time::S), true);
